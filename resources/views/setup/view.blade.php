...
@section('content')
    ...
    <!-- Tabs -->
    {!! Breadcrumbs::render('setup.index') !!}
    <div style="padding-left: 15px; padding-right: 15px; margin-top: 0">
        <ul class="nav nav-tabs" id="tabslabels">
            ...
            <li ><a data-toggle="tab" href='#clienttab'>Mobile App setup (oAuth)</a></li>
        ...
        <div class="tab-content">
            ...
            <div id="clienttab" class="tab-pane ">
                <fieldset style="width: 90%">
                    <legend>Mobile App oAuth parameters
                        <button id="edit_patient_but" class="btn btn-info btn-lg" data-toggle="modal"
                                data-target="#placeholderdialog">Edit
                        </button>
                    </legend>
                    These settings shouldn't change, but there may be a need to at some point
            ...
            <div id="mediatab" class="tab-pane ">
                <fieldset style="width: 90%">
                    <legend>Associated Media
                        <button id="edit_patient_but" class="btn btn-info btn-lg" data-toggle="modal"
                                data-target="#placeholderdialog">Add
                        </button>
                    </legend>
