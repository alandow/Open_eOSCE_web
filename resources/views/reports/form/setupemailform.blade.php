...
<div class="form-group row">
    <div class="col-sm-12"><label class="'control-label text-left"><span
                    style="text-decoration: underline;">Exclude</span> items from report</label></div>
...
<div class="form-group row">
    <div class="col-sm-12"><label class="'control-label text-left"><span
                    style="text-decoration: underline;">Exclude</span> comments from report</label></div>
    <div class="col-sm-12">
        <div class="checkbox checkbox-danger">
